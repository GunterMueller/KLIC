...
\includegraphics[width=.35\textwidth]{fig/dist.eps}
\end{center}
...
\includegraphics[width=8cm]{fig/dklic-conf.eps}
...
%\includegraphics[width=6cm]{fig/rok_shoen_throw.eps}\\
%\begin{small}
%(1) ゴールの送信
%\end{small}
%\end{center}
...
%\includegraphics[width=6cm]{fig/rok_shoen_receive_term.eps}\\
%\begin{small}
%(2) ゴールの受信と重みの返却
%\end{small}
%\end{center}
...
\includegraphics[width=.5\textwidth]{fig/shoen-throw-receive.eps}
...
%\includegraphics[width=6.5cm]{fig/rok_shoen_check_send.eps}\\
...
%\includegraphics[width=6.5cm]{fig/rok_shoen_check_reply.eps}\\
%{\small (2) 状態に応じて{\roksuspendedmessage}を返信する。}
%\end{center}
%\end{minipage}
%%\epsfile{file=shoen-check.eps,width=.6\textwidth}
\includegraphics[width=.5\textwidth]{fig/shoen-check.eps}
\caption{荘園の中断検出}
\label{rokcheck}
\end{center}
\end{figure}
...
\includegraphics[width=5.6cm]{fig/rok_split_export.eps}\\
{\small (1) 重みを分割して輸出する。}
\end{center}
\vspace{18pt}
\end{minipage}
...
\includegraphics[width=5.6cm]{fig/rok_release_exref.eps}\\
...
\includegraphics[scale=0.85]{fig/rok_indirect_export.eps}
...
\includegraphics[width=8cm]{fig/dklic-initproc.eps}
...
%\includegraphics{fig/klic-pvm.eps,width=15cm}
