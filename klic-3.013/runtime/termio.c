  ...
  Const struct predicate *toppred;
{
 ...
 module_top:
  ...
  switch_on_pred() {
    ...
    case_pred(8, bound__sock_2_top);
    case_pred(9, in_3_top);
    case_pred(10, out_3_top);
    case_pred(11, updt_3_top);
    case_pred(12, addop_5_top);
    case_pred(13, addop2_5_top);
    case_pred(14, rmop_4_top);
    case_pred(15, rmop2_4_top);
    case_pred(16, default__operator__table_1_top);
    case_pred(17, output__stream_2_top);
    case_pred(18, string__output_4_top);
    case_pred(19, compute__string__length_3_top);
    case_pred(20, fill__string_4_top);
    case_pred(21, set__string__elements_6_top);
    case_pred(22, string__input_5_top);
    last_case_pred(23, update__lc_3_top);
  }
 ...
 termupdt_2_1:
  switch (ptagof(a0)) {
 case FUNCTOR:
  if (functor_of(a0) != makesym(functor_normal_1)) goto termupdt_2_2;
  allocp[0] = makesym(functor_normal_1);
  allocp[1] = x1 = makeref(&allocp[1]);
  x0 = makefunctor(&allocp[0]);
  allocp += 2;
