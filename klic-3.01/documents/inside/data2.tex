...
\includegraphics[width=.5\textwidth]{sample-struct.eps}
% \vspace{1cm}
\end{center}
\caption{KL1の項の例}
...
\includegraphics[width=.35\textwidth]{cons.eps}
%\epsfile{file=func.eps,width=.3\textwidth}
\includegraphics[width=.35\textwidth]{func.eps}
\end{center}
\caption{CONSとファンクタ}
\label{cons-func}
\end{figure}
...
\includegraphics[width=.8\textwidth]{ref-desc.eps}
\caption{参照セルの例}
\label{ref-desc}
\end{center}
\end{figure}
...
\includegraphics[width=.9\textwidth]{undef.eps}
...
\includegraphics[width=.8\textwidth]{m_nakamu_doi.eps}
...
\includegraphics[width=.6\textwidth]{m_nakamu_coi.eps}
...
\includegraphics[width=.8\textwidth]{generator-struct.eps}
...
\includegraphics[width=.5\textwidth]{heap.eps}
\end{center}
\caption{ヒープの利用}
\label{heap}
\end{figure}
...
\includegraphics[width=.7\textwidth]{suspstruct.eps}
\end{center}
...
\includegraphics[width=.4\textwidth]{single-susp.eps}
