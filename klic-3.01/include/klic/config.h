/*
  ...
  Date of Confuguration: Mon Oct 16 02:13:01 EDT 2017
  Configured by: gunter
*/
...
#define KLICBIN "/usr/local/klic/bin"
#define KLICLIB "/usr/local/klic/lib"
#define KLICINCLUDE "/usr/local/include"
#define KLICINCLUDE0 ""
#define KLIC_COMPILER "/usr/local/klic/lib/klic/kl1cmp"
#define KLIC_DBMAKER "/usr/local/klic/lib/klic/klicdb"
...
#define LIBRARIES "-lklic -lklicm -L/usr/lib32 -L/usr/lib/system -L/usr/lib   -lm"
#define LIBRARIES_T "-lklict -lklicm -L/usr/lib32 -L/usr/lib/system -L/usr/lib   -lm"
#define LIBRARIES_D "-lklicd -lklicm -L/usr/lib32 -L/usr/lib/system -L/usr/lib   -lm"
#define LIBRARIES_S "-lklics -lklicm -L/usr/lib32 -L/usr/lib/system -L/usr/lib   -lm"
#define KLIC_CC_OPTIONS "-O1"
