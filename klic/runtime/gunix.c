...
Const struct predicate predicate_unix_xasync__output_4 =
   { module_unix, 28, 4 };
Const struct predicate predicate_unix_xsend__mcast_2 =
   { module_unix, 29, 2 };
Const struct predicate predicate_unix_xbind__mcast_2 =
   { module_unix, 30, 2 };
Const struct predicate predicate_unix_xready__mcast_5 =
   { module_unix, 31, 5 };
Const struct predicate predicate_unix_xready__mcast2_4 =
   { module_unix, 32, 4 };
Const struct predicate predicate_unix_xconnected__mcast_2 =
   { module_unix, 33, 2 };
Const struct predicate predicate_unix_xbound__mcast_3 =
   { module_unix, 34, 3 };
  ...
  Const struct predicate *toppred;
{
 ...
 module_top:
  switch_on_pred() {
    ...
    case_pred(29, send__mcast_2_top);
    case_pred(30, bind__mcast_2_top);
    case_pred(31, ready__mcast_5_top);
    case_pred(32, ready__mcast2_4_top);
    case_pred(33, connected__mcast_2_top);
    case_pred(34, bound__mcast_3_top);
    ...
    case_pred(52, times_4_top);
    last_case_pred(53, dummy_0_top);
  }
...
klic_exit((intval(a0)));
 ...
 case functor_bind__mcast_2:
  ...
  qp = (struct goalrec*)&allocp[0];
  allocp += 5;
  execute(bind__mcast_2_0);
  goto bind__mcast_2_ext_interrupt;
 case functor_send__mcast_2:
  allocp[0] = (q)qp;
  allocp[1] = (q)(&predicate_unix_xcont_3);
  allocp[2] = x1 = makeref(&allocp[2]);
  x2 = arg(x0, 1);
  ...
  qp = (struct goalrec*)&allocp[0];
  allocp += 5;
  execute(send__mcast_2_0);
  goto send__mcast_2_ext_interrupt;
  };
  ...
  
{
 ...
 async__io_5_2:
  switch (ptagof(x0)) {
 case ATOMIC:
  if (!isint(x0)) goto async__io_5_37;
 async__io_5_3:
  gblt_integer(x0,async__io_5_37);
 async__io_5_4:
  switch (ptagof(a3)) {
 case FUNCTOR:
 async__io_5_5:
  if (!isgobj(a3)) goto async__io_5_37;
  if (!isclass(a3,pointer)) goto async__io_5_37;
  
{
 ...
 case FUNCTOR:
 async__io_5_7:
  if (!isgobj(a2)) goto async__io_5_37;
  if (!isclass(a2,pointer)) goto async__io_5_37;
 async__io_5_8:
  ...
  
{
  ...
  goto async__io_5_ext_interrupt;
 async__io_5_9:
  if (!isref(a4)) goto async__io_5_37;
 ...
 async__io_5_11:
  ...
  if (!isclass(a2,pointer)) goto async__io_5_37;
 async__io_5_12:
  if (!isint(a4)) goto async__io_5_13;
  
{
 ...
 async__io_5_13:
  if (!isref(a4)) goto async__io_5_37;
  deref_and_jump(a4,async__io_5_12);
  *reasonp++ =  a4;
  goto async__io_5_37;
 case VARREF:
 ...
 async__io_5_15:
  ...
  x1 = arg(x0, 0);
 async__io_5_16:
  if (!isint(x1)) goto async__io_5_19;
 async__io_5_17:
  if (!isint(a4)) goto async__io_5_18;
  
{
 ...
 async__io_5_18:
  if (!isref(a4)) goto async__io_5_37;
  deref_and_jump(a4,async__io_5_17);
  *reasonp++ =  a4;
  goto async__io_5_37;
 async__io_5_19:
  if (!isref(x1)) goto async__io_5_37;
  deref_and_jump(x1,async__io_5_16);
  *reasonp++ =  x1;
  goto async__io_5_37;
 case VARREF:
  deref_and_jump(a2,async__io_5_14);
  *reasonp++ =  a2;
  goto async__io_5_37;
  };
  goto async__io_5_37;
  ...
  
{
  ...
  goto async__io_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a2,async__io_5_20);
  *reasonp++ =  a2;
  goto async__io_5_37;
  };
  goto async__io_5_37;
 ...
 case FUNCTOR:
 async__io_5_23:
  if (!isgobj(x1)) goto async__io_5_37;
 async__io_5_24:
  gblt_is_string(x1,async__io_5_37);
  gblt_size_of_string(x1,x2,async__io_5_37);
  gblt_element_size_of_string(x1,x3,async__io_5_37);
 async__io_5_25:
  if (x3 != makeint(8L)) goto async__io_5_37;
 async__io_5_26:
  switch (ptagof(a3)) {
 case FUNCTOR:
 async__io_5_27:
 ...
 async__io_5_28:
  if (!isgobj(x1)) goto async__io_5_37;
  if (!isclass(x1,byte__string)) goto async__io_5_37;
  
{
  ...
  goto async__io_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a3,async__io_5_26);
  *reasonp++ =  a3;
  goto async__io_5_37;
  };
  goto async__io_5_37;
 case VARREF:
  deref_and_jump(x1,async__io_5_22);
  *reasonp++ =  x1;
  goto async__io_5_37;
  };
  goto async__io_5_37;
...
#ifdef ASYNCIO
{
  ...
  goto async__io_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a3,async__io_5_31);
  *reasonp++ =  a3;
  goto async__io_5_37;
  };
  goto async__io_5_37;
  ...
  *reasonp++ =  x0;
  ...
  goto async__io_5_37;
 case ATOMIC:
  if (a0 != NILATOM) goto async__io_5_37;
 async__io_5_33:
  switch (ptagof(a3)) {
 case FUNCTOR:
 async__io_5_34:
  ...
  
{
  ...
  proceed();
 case VARREF:
  deref_and_jump(a2,async__io_5_35);
  *reasonp++ =  a2;
  goto async__io_5_37;
  };
  goto async__io_5_37;
 case VARREF:
  deref_and_jump(a3,async__io_5_33);
  *reasonp++ =  a3;
  goto async__io_5_37;
  };
  goto async__io_5_37;
 ...
 case CONS:
  ...
  goto async__io_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a1,async__io_5_38);
  *reasonp++ =  a1;
...
#ifdef ASYNCIO
{
 ...
 send__mcast_2_top: {
  ...
  a1 = qp->args[1];
  qp = qp->next;
 send__mcast_2_clear_reason:
  reasonp = reasons;
 send__mcast_2_0:
 send__mcast_2_1:
  switch (ptagof(a0)) {
 case FUNCTOR:
  if (functor_of(a0) != makesym(functor_inet_2)) goto send__mcast_2_interrupt;
  x0 = arg(a0, 0);
  x1 = arg(a0, 1);
  ...
  a0 = x0;
  allocp += 1;
  execute(ready__mcast_5_0);
  goto ready__mcast_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a0,send__mcast_2_1);
  *reasonp++ =  a0;
  goto send__mcast_2_interrupt;
  };
  goto send__mcast_2_interrupt;
 send__mcast_2_ext_interrupt:
  reasonp = 0l;
 send__mcast_2_interrupt:
  toppred = &predicate_unix_xsend__mcast_2;
  goto interrupt_2;
 }
 ...
 bind__mcast_2_top: {
  ...
  a1 = qp->args[1];
  qp = qp->next;
 bind__mcast_2_clear_reason:
  reasonp = reasons;
 bind__mcast_2_0:
 bind__mcast_2_1:
  switch (ptagof(a0)) {
 case FUNCTOR:
  if (functor_of(a0) != makesym(functor_inet_2)) goto bind__mcast_2_interrupt;
  x0 = arg(a0, 0);
  x1 = arg(a0, 1);
  allocp[0] = x2 = makeref(&allocp[0]);
  a2 = x2;
  ...
  goto ready__mcast_5_ext_interrupt;
 case VARREF:
  deref_and_jump(a0,bind__mcast_2_1);
  *reasonp++ =  a0;
  goto bind__mcast_2_interrupt;
  };
  goto bind__mcast_2_interrupt;
 bind__mcast_2_ext_interrupt:
  reasonp = 0l;
 bind__mcast_2_interrupt:
  toppred = &predicate_unix_xbind__mcast_2;
  goto interrupt_2;
 }
 ...
 case FUNCTOR:
 ready__mcast_5_2:
  if (!isgobj(a0)) goto ready__mcast_5_interrupt;
  if (!isclass(a0,byte__string)) goto ready__mcast_5_interrupt;
 ready__mcast_5_3:
  if (!isint(a1)) goto ready__mcast_5_6;
 ready__mcast_5_4:
  if (!isint(a4)) goto ready__mcast_5_5;
  
{
  ...
  a2 = x0;
  a3 = a4;
  execute(ready__mcast2_4_clear_reason);
  goto ready__mcast2_4_ext_interrupt;
 ready__mcast_5_5:
  if (!isref(a4)) goto ready__mcast_5_interrupt;
  deref_and_jump(a4,ready__mcast_5_4);
  *reasonp++ =  a4;
  goto ready__mcast_5_interrupt;
 ready__mcast_5_6:
  if (!isref(a1)) goto ready__mcast_5_interrupt;
  deref_and_jump(a1,ready__mcast_5_3);
  *reasonp++ =  a1;
  goto ready__mcast_5_interrupt;
 case VARREF:
  deref_and_jump(a0,ready__mcast_5_1);
  *reasonp++ =  a0;
  goto ready__mcast_5_interrupt;
  };
  goto ready__mcast_5_interrupt;
 ready__mcast_5_ext_interrupt:
  reasonp = 0l;
 ready__mcast_5_interrupt:
  toppred = &predicate_unix_xready__mcast_5;
  goto interrupt_5;
 }
 ...
 ready__mcast2_4_top: {
  ...
  a3 = qp->args[3];
  qp = qp->next;
 ready__mcast2_4_clear_reason:
  reasonp = reasons;
 ready__mcast2_4_0:
 ready__mcast2_4_1:
  if (!isint(a3)) goto ready__mcast2_4_3;
  x0 = makeint(1L);
  gblt_eq(a3,x0,ready__mcast2_4_2);
  execute(bound__mcast_3_0);
  goto bound__mcast_3_ext_interrupt;
 ready__mcast2_4_2:
  x1 = makeint(0L);
  gblt_eq(a3,x1,ready__mcast2_4_interrupt);
  a1 = a2;
  execute(connected__mcast_2_0);
  goto connected__mcast_2_ext_interrupt;
 ready__mcast2_4_3:
  if (!isref(a3)) goto ready__mcast2_4_interrupt;
  deref_and_jump(a3,ready__mcast2_4_1);
  *reasonp++ =  a3;
  goto ready__mcast2_4_interrupt;
 ready__mcast2_4_ext_interrupt:
  reasonp = 0l;
 ready__mcast2_4_interrupt:
  toppred = &predicate_unix_xready__mcast2_4;
  goto interrupt_4;
 }

 connected__mcast_2_top: {
  q x0, x1;
  a0 = qp->args[0];
  a1 = qp->args[1];
  qp = qp->next;
 connected__mcast_2_clear_reason:
  reasonp = reasons;
 connected__mcast_2_0:
 connected__mcast_2_1:
  switch (ptagof(a0)) {
 case CONS:
  x0 = car_of(a0);
 connected__mcast_2_2:
  switch (ptagof(x0)) {
 case FUNCTOR:
  if (functor_of(x0) != makesym(functor_put_1)) goto connected__mcast_2_interrupt;
  x1 = arg(x0, 0);
 connected__mcast_2_3:
  if (!isint(x1)) goto connected__mcast_2_6;
 connected__mcast_2_4:
  switch (ptagof(a1)) {
 case FUNCTOR:
 connected__mcast_2_5:
  if (!isgobj(a1)) goto connected__mcast_2_interrupt;
  if (!isclass(a1,pointer)) goto connected__mcast_2_interrupt;
  
{
#ifdef ASYNCIO
  struct iobuf *iob = IOBuf(a1);
  /** no buffering **/
  *iob->ptr++ = intval(x1);
  switch (write_buf(iob)) {
    case -1: goto connected__mcast_2_interrupt;
    case 1: break;
  }
#else
  goto connected__mcast_2_interrupt;
#endif
}
  a0 = cdr_of(a0);
  execute(connected__mcast_2_clear_reason);
  goto connected__mcast_2_ext_interrupt;
 case VARREF:
  deref_and_jump(a1,connected__mcast_2_4);
  *reasonp++ =  a1;
  goto connected__mcast_2_interrupt;
  };
  goto connected__mcast_2_interrupt;
 connected__mcast_2_6:
  if (!isref(x1)) goto connected__mcast_2_interrupt;
  deref_and_jump(x1,connected__mcast_2_3);
  *reasonp++ =  x1;
  goto connected__mcast_2_interrupt;
 case VARREF:
  deref_and_jump(x0,connected__mcast_2_2);
  *reasonp++ =  x0;
  goto connected__mcast_2_interrupt;
  };
  goto connected__mcast_2_interrupt;
 case ATOMIC:
  if (a0 != NILATOM) goto connected__mcast_2_interrupt;
 connected__mcast_2_7:
  switch (ptagof(a1)) {
 case FUNCTOR:
 connected__mcast_2_8:
  if (!isgobj(a1)) goto connected__mcast_2_interrupt;
  if (!isclass(a1,pointer)) goto connected__mcast_2_interrupt;
  
{
  ...
  proceed();
 case VARREF:
  deref_and_jump(a1,connected__mcast_2_7);
  *reasonp++ =  a1;
  goto connected__mcast_2_interrupt;
  };
  goto connected__mcast_2_interrupt;
 case VARREF:
  deref_and_jump(a0,connected__mcast_2_1);
  *reasonp++ =  a0;
  goto connected__mcast_2_interrupt;
  };
  goto connected__mcast_2_interrupt;
 connected__mcast_2_ext_interrupt:
  reasonp = 0l;
 connected__mcast_2_interrupt:
  toppred = &predicate_unix_xconnected__mcast_2;
  goto interrupt_2;
 }
 ...
 bound__mcast_3_2:
  switch (ptagof(x0)) {
 case FUNCTOR:
  if (functor_of(x0) != makesym(functor_get_2)) goto bound__mcast_3_8;
 bound__mcast_3_3:
  switch (ptagof(a1)) {
 case CONS:
 bound__mcast_3_4:
 ...
 case FUNCTOR:
 bound__mcast_3_5:
  if (!isgobj(a2)) goto bound__mcast_3_8;
  if (!isclass(a2,pointer)) goto bound__mcast_3_8;
  
{
  ...
  if(iob->ptr == iob->lim){  /** In InputBuffer, ptr==lim is true.**/
    ...
    case -1: goto bound__mcast_3_8;
    case -2: goto bound__mcast_3_8;
    case 0:  c = -1; break;
    case 1:  c = *iob->ptr++; break;
    }
  }
  ...
  a0 = cdr_of(a0);
  a1 = cdr_of(a1);
  execute(bound__mcast_3_clear_reason);
  goto bound__mcast_3_ext_interrupt;
 case VARREF:
  deref_and_jump(a2,bound__mcast_3_4);
  *reasonp++ =  a2;
  goto bound__mcast_3_8;
  };
  goto bound__mcast_3_8;
 case VARREF:
  deref_and_jump(a1,bound__mcast_3_3);
  *reasonp++ =  a1;
  goto bound__mcast_3_8;
  };
  goto bound__mcast_3_8;
 case VARREF:
  deref_and_jump(x0,bound__mcast_3_2);
  *reasonp++ =  x0;
  goto bound__mcast_3_8;
  };
  goto bound__mcast_3_8;
 case ATOMIC:
  if (a0 != NILATOM) goto bound__mcast_3_8;
 bound__mcast_3_6:
  switch (ptagof(a2)) {
 case FUNCTOR:
 bound__mcast_3_7:
  ...
  
{
  ...
  proceed();
 case VARREF:
  deref_and_jump(a2,bound__mcast_3_6);
  *reasonp++ =  a2;
  goto bound__mcast_3_8;
  };
  goto bound__mcast_3_8;
 case VARREF:
  deref_and_jump(a0,bound__mcast_3_1);
  *reasonp++ =  a0;
  goto bound__mcast_3_8;
  };
  goto bound__mcast_3_8;
 ...
 case CONS:
  ...
  goto bound__mcast_3_ext_interrupt;
 case VARREF:
  deref_and_jump(a1,bound__mcast_3_9);
  *reasonp++ =  a1;
  goto bound__mcast_3_interrupt;
  };
  goto bound__mcast_3_interrupt;
 bound__mcast_3_ext_interrupt:
  reasonp = 0l;
 bound__mcast_3_interrupt:
  toppred = &predicate_unix_xbound__mcast_3;
  goto interrupt_3;
 }
  ...
  
{
  ...
  if( mkstemp(real_template) < 0 ) real_template[0] = ' ';
