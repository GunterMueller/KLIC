...
#define before_pcheck_hook_table   (glbl->before_pcheck_hook_table0)
#define before_pcheck_hooktab_size (glbl->before_pcheck_hooktab_size0)
#define num_before_pcheck_hooks	   (glbl->num_before_pcheck_hooks0)
...
Extern struct global_variables {
  ...
  int num_gc_hooks0;
  q* (**before_pcheck_hook_table0)();
  int before_pcheck_hooktab_size0;
  int num_before_pcheck_hooks0;
